...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 analyze_MC-n.py <sequence> <trajectory_file>")
        sys.exit()
    ...
    exact_results = analyze_paths(possible_paths, sequence, Beta, Epsilon)

    print("\nExact enumeration results")
    print("Number of exact paths:", exact_results["n_paths"])
    print("Expected energy:", exact_results["expected_energy"])
    print("Expected end2end:", exact_results["expected_end2end"])
